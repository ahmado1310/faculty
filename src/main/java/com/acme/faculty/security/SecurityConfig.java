...
import static com.acme.faculty.security.Rolle.USER;
    ...
    default SecurityFilterChain securityFilterChain(
        ...
        return http
            .authorizeHttpRequests(authorize -> {
                final var restPathfacultyId = REST_PATH + "/*";
                authorize
                    ...
                    .requestMatchers(GET, restPathfacultyId).hasAnyRole(ADMIN.name(), USER.name())
                    .requestMatchers(PUT, restPathfacultyId).hasRole(ADMIN.name())
                    .requestMatchers(PATCH, restPathfacultyId).hasRole(ADMIN.name())
                    .requestMatchers(DELETE, restPathfacultyId).hasRole(ADMIN.name())
