...
-- (5) 2. PowerShell:
--     docker compose exec db bash
--        psql --dbname=postgres --username=postgres --file=/sql/create-db-faculty.sql
--        psql --dbname=faculty --username=faculty --file=/sql/create-schema-faculty.sql
...
CREATE ROLE faculty LOGIN PASSWORD 'p';

-- https://www.postgresql.org/docs/current/sql-createdatabase.html
CREATE DATABASE faculty;

-- https://www.postgresql.org/docs/current/sql-grant.html
GRANT ALL ON DATABASE faculty TO faculty;

-- https://www.postgresql.org/docs/10/sql-createtablespace.html
CREATE TABLESPACE facultyspace OWNER faculty LOCATION '/var/lib/postgresql/tablespace/faculty';
