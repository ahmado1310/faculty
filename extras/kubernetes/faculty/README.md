...
| Name | Email | Url |
| ---- | ------ | --- |
| Ahmad Hawarnah | <ahmadooo.ahmad44@gmail.com> | <https://www.h-ka.de> |
...
| datasource.url | string | `"jdbc:postgresql://localhost/faculty"` | URL für den DB-Zugriff |
| datasource.username | string | `"faculty"` | Benutzername für das DB-System |
...
| image.name | string | `"faculty"` | Name des Image |
| image.pullPolicy | string | `"Always"` | Pull-Policy für das Image |
| image.repository | string | `"ahmadhawarnah"` | Repository als Präfix beim Image-Namen |
