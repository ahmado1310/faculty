...
java -Djarmode=layertools -jar ./build/libs/faculty-2024.04.0.jar extract
...
LABEL org.opencontainers.image.title="faculty" \
      org.opencontainers.image.description="Microservice faculty v0 mit Basis-Image Azul Zulu und Ubuntu Jammy" \
