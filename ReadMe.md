...
```powershell
    docker inspect juergenzimmermann/kunde:2024.04.1-buildpacks
    docker inspect juergenzimmermann/kunde:2024.04.1-azul
    docker inspect juergenzimmermann/kunde:2024.04.1-eclipse
```
...
```powershell
    docker scout quickview juergenzimmermann/kunde:2024.04.1-buildpacks
```
...
```powershell
    ...
    docker scout cves juergenzimmermann/kunde:2024.04.1-buildpacks
    docker scout cves --format only-packages juergenzimmermann/kunde:2024.04.1-buildpacks

    # Analyse des Images mit Azul Zulu und Ubuntu Jammy
    docker scout cves juergenzimmermann/kunde:2024.04.1-azul

    # Analyse des Images mit Eclipse Temurin und Ubuntu Jammy
    docker scout cves juergenzimmermann/kunde:2024.04.1-eclipse

    # Analyse des Images mit Cloud-Native Buildpacks sowie Azul Zulu und Ubuntu Jammy
    docker scout cves juergenzimmermann/kunde:2024.04.1-buildpacks-azul

    # Analyse des Images mit Cloud-Native Buildpacks sowie Eclipse Temurin und Ubuntu Jammy
    docker scout cves juergenzimmermann/kunde:2024.04.1-buildpacks-eclipse
````
